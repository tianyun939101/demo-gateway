...
databaseChangeLog(logicalFilePath: 'script/db/hpfm_dashboard_clause.groovy') {
    ...
    changeSet(author: "xiaoyu.zhao@hand-china.com", id: "2019-05-08-hpfm_dashboard_clause") {
        addDefaultValue(tableName: "hpfm_dashboard_clause", columnName: "tenant_id", defaultValue: "0")
    }
}
